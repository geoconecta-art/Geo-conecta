    ...
    <head>
        ...
        <style>
            ...
            .btn-warning:focus, .btn-warning.focus {
                ...
                background-color: #ee781d;
                border-color: #ee781d;
                box-shadow: 0 0 0 0.2rem rgb(246 199 50 / 50%);
            }
        ...
        <div class="relative flex items-top justify-center min-h-screen dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="items-center pt-8 sm:justify-start sm:pt-0">
                    <img src="{{ asset('assets/images/logoTerritorio.png') }}" width="400">

                    <!--
                    <div class="ml-4 text-lg text-gray-500 uppercase tracking-wider">
                        403 | Esta es una acción no autorizada                    
                    </div>
                    -->

                    <div class="px-4 text-lg text-gray-500 tracking-wider text-center" style="margin-bottom:1rem;">
                        Parece que estás perdido                 
                    </div>

                    <div class="text-center">
                        @if ( Auth::user()->hasRole('Capturista') ) 
                            <a class="btn" href="{{ route('plans.index') }}">Volver a la Captura</a>
                        @else 
                            <a class="btn" href="{{ route('stats.index') }}">Volver</a>
                        @endif
                    </div>
