        ...
        <div class="components-preview">
            ...
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">Promovido sin clave</h4>
                </div>
            </div>

            @if ( Auth::user()->hasRole('Super Administrador') || ( Auth::user()->hasRole('Administrador') &&  !Auth::user()->hasRole('Consultor') ) ) 
            <form id="personForm" action="{{ route('promoted.store-by-admin') }}" method="POST" enctype="multipart/form-data" >
            @else
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                @include('admin.promoted._formWOC')
                                            </div>
