    ...
    <div class="col-md-6 mb-3">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="hidden" class="form-control" name="ine"
                    value="" maxlength="18" 
                    id="ine">
            </div>
...
<input type="hidden" name="type" value="sc" id="type">

<script>
        /*
        // Se genera folio para promovidos sin ine
        window.onload = function() {
            fetch('/get-folio')
                .then(response => response.json())
                .then(data => {
                    if (data.folio) {
                        $('input[name=ine]').val(data.folio);
                    } else {
                        $('input[name=ine]').val('0');
                    }
                })
                .catch(error => {
