            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    ...
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Apoyos Entregados</h3>
                    </div>
                    ...
                    <div class="card-inner-group">
                        ...
                        <div class="row mb-5 px-4">
                                <div class="col-12 text-right">
                                    <a href="{{ route('support.delive.create') }}" class="btn btn-outline-light">
                                        <span>Registrar Entrega de Apoyo</span><em class="icon ni ni-add"></em>
                                    </a>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        ...
        var tablePath = '{{ route('support.deliver.table') }}';
        function updateDataTable() {
            ...
            $('#itemsTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'name', name: 'name' },
                    { data: 'beneficiary_first_name', name: 'beneficiary_first_name' },
                    { data: 'cost', name: 'cost' },
                ],
