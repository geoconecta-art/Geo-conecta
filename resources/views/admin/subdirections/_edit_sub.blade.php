...
<div class="modal-header">
    <h5 class="modal-title">Editar Subdirección / Área</h5>
</div>
    ...
    <div class="row">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="direction" name="id_direction" @if (!Auth::user()->hasRole("Super Administrador")) disabled @endif>
                    ...
                    @foreach ($areas as $area)
                        <option value="{{$area['_id']}}" @if ( $area->id == $subdirection->id_area ) selected @endif >
                            {{$area['name']}} 
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col-md-12 mb-3">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_subdirection" placeholder="Escriba el nombre de la Subdirección / Área..." name="newName" value="{{$subdirection['name']}}">
...
<div class="modal-footer">
    ...
    <div class="btn btn-dim btn-success" onclick="editSubdirection('{{$subdirection['_id']}}')">
        Actualizar
    </div>
</div>