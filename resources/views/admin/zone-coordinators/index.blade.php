                        ...
                        <div class="card-inner py-5">
                            ...
                            <div class="row mb-5">
                                <div class="col-12 text-right">
                                    ...
                                    <a href="{{ route('z-coordinators.create') }}" class="btn btn-outline-light">
...
@section('script')
    ...
    <script>
        ...
        var tablePath = '{{ route('z-coordinators.table') }}' + '?type=4';
        var reportPath = '{{ route('reports.z-coordinators') }}' + '?tipo=4';
        ...
        function downloadReport() {
            ...
            params += '&secciones=' + sectionsStr + '&coord_reg=' + coordId;
