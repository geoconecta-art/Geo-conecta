...
<form class="modal-body" id="create_plan_form">
    <div class="row pr-0">
        ...
        {{-- <div class="row col-12 pl-5">
            <small>
                ...
                Al seleccionar el color considere el contraste que debe generarse con el mapa.
            </small>
        </div> --}}
    </div>
...
<div class="modal-footer">
    ...
    <div class="btn btn-dim btn-success" onclick="createPlaneacion()">
        Crear
    </div>
</div>
