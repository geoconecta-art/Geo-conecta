...
<header>
    <table width="100%">
        <tbody>
        <tr>
            <td width="100%" style="text-align:center;">PROMOTOR</b></td>
        </tr>
        <tr>
...
<footer>
    <table width="100%" style="/*border-top:1px solid #c0c0c0;*/">
        ...
        <tr>
            ...
            <td style="text-align:right;">Página <span class="pagenum"></span> de 3</td>
        </tr>
        </tbody>
    </table>
</footer>
    ...
    <table width="100%" cellspacing="0" class="people-table">
        ...
        @foreach( $mobilizers as $mobilizer )
            <tr>
                ...
                <td>{{ $mobilizer->sections }}</td>
                <td>{{ $mobilizer->s_coordinator }}</td>
                <td>{{ $mobilizer->z_coordinator }}</td>
                <td>{{ $mobilizer->r_coordinator }}</td>
                <td>{{ $mobilizer->director }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
