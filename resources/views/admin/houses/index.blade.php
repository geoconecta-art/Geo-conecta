                            ...
                            <div class="row mb-5">
                                <div class="col-12 text-right">
                                    ...
                                    <div onclick="downloadReport(2)"
                                        class="btn btn-primary mr-md-2 mb-3 mb-md-0">
                                        <span>Exportar Excel con imágenes</span><em class="icon ni ni-download"></em>
                                    </div>
...
@section('script')
    ...
    <script>
        ...
        var tablePath = '{{ route('houses.table') }}';
        ...
        function downloadReport(type) {
            window.location.href = '{{ route('reports.houses') }}?type=' + type + '';
        }
