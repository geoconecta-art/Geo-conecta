<script>
    ...
    $('select[name=section]').on('change', function () {
        ...
        $.post('/volunteers/get-section-info', { 
            '_token':_token, 
            'section':section 
        }, function(data) {
    ...
    document.getElementById('personForm').addEventListener('submit', function(event) {
        ...
        if ( !validateForm() ) {
            ...
            // Registrar submit
            localStorage.setItem('storeHouse', 1);
    ...
    function validateImages() {
        ...
        //var ineHtml = $('.ine-c .dropify-render').html(); || ineHtml === ''

        if ( imgHtml === '' ) {
            showWarningModal('Carga la imagen para continuar.');
            return false;
        }
