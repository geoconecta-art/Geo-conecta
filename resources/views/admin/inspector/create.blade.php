        ...
        <div class="components-preview wide-md mx-auto">
            ...
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">Crear Evaluación y Seguimiento</h4>
                </div>
            </div>
            ...
            <form id="personForm" 
                action="{{ route('inspectors.store-by-admin') }}" 
                method="POST" enctype="multipart/form-data" >
            @else
            <form id="personForm" 
                action="{{ route('inspectors.store') }}" 
                method="POST" enctype="multipart/form-data" >
            @endif
...
@section('script')
    ...
    @include('admin.inspector._script')
    ...
    @if ( !$errors->any() )
        ...
        var storeIns = localStorage.getItem('storeIns');

        if ( storeIns == 1 ) {

            localStorage.setItem('storeIns', 0);

            Swal.fire(
                '¡Alta exitosa!',
                'Fiscalizador registrado correctamente',
                'success'
            );
        }
    @endif
