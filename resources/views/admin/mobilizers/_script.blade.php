<script>
    ...
    $('select[name=section]').on('change', function () {
        ...
        $.post('/mobilizers/get-section-info', { 
            '_token':_token, 
            'section':section 
        }, function(data) {
            ...
            if ( typeof personId != 'undefined' ) {
                $('select[name=person_id]').val(personId);
                personId = undefined;
                //$('select[name=person_id]').prop('disabled', true);
            }

            if ( typeof mr != 'undefined' ) {
                $('select[name=mr]').val(mr);
                mr = undefined;
        ...
        $.post('/mobilizers/validate-by-section', { 
            ...
            if ( !response.success ) {
                ...
                if ( !validateForm() ) {
                    ...
                    // Registrar submit
                    localStorage.setItem('storeMob', 1);
