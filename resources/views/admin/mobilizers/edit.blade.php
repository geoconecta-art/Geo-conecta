        ...
        <div class="components-preview wide-md mx-auto">
            ...
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title">Promotor</h4>
                </div>
            </div>
            ...
            <div class="nk-block">
                ...
                <div class="card card-preview">
                    <div class="card-inner">
                        ...
                        <form id="personForm" action="{{ route('mobilizers.update', $person->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                                ...
                                <div class="row">
                                            ...
                                            <div class="form-control-wrap ">
                                                <div class="form-control-select">
                                                    <select class="form-control" 
                                                            name="section" required @if ( !$edit ) disabled @endif >
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control" name="person_id" required disabled>
                                                        <option selected disabled value="">Búsqueda por Nombre o ID</option>
                                                        foreach ($people as $p)
                                                            <option value="{ $p->id }}" 
                                                                if ( $p->id == $person->person_id ) selected endif >
                                                                { $p->name }} (ID: { $p->id }})
                                                            </option>
                                                        endforeach
                                                    </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select class="form-control" name="section" required disabled>
                                                        <option selected disabled value="">Selecciona una opción</option>
                                                        foreach ($all_sections as $section)
                                                            <option value="{ $section }}" 
                                                                if ( $person->section == $section ) selected endif >
                                                                { $section }}
                                                            </option>
                                                        endforeach
                                                    </select>
