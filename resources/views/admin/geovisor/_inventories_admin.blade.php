...
<div class="mx-2" style="height: calc(100vh - 324px);overflow-y: auto;">
    @foreach ($areas as $area)
        <div class="accordion mb-3 border-0" id="accordion-plan-{{ $area->id }}">

            <div class="accordion-item border-0 accordion-plan-area" id="{{ $area->id }}">
                <button href="#" class="accordion-head accordion-head-area p-1 collapsed rounded-3 border-0 w-100" data-bs-toggle="collapse" data-bs-target="#accordion-plan-area-{{$area->id}}">
                    <h6 class="title text-white text-start" style="width: 80%; font-size: small;">
                        {{ $area->name }}
                    </h6>
                    <span class="text-white accordion-icon"></span>
                </button>

                <div class="accordion-body collapse border-0" id="accordion-plan-area-{{$area->id}}" data-bs-parent="#accordion-plan-{{ $area->id }}">
                    <div class="accordion-inner px-1 py-2">
        
                        @foreach ($area->subareas as $subarea)
                            <div class="accordion mb-2 border-0" id="accordion-plan-{{ $subarea->id }}">
                                ...
                                <div class="accordion-item border-0 accordion-plan-subarea" id="{{ $subarea->id }}">
                                    ...
                                    <div class="accordion-body collapse border-0" id="accordion-plan-subarea-{{$subarea->id}}" data-bs-parent="#accordion-plan-{{ $subarea->id }}">
