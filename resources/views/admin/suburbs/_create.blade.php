...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-9 mb-1">
            <div class="mb-1">
                <label for="suburb_name" class="form-label">Nombre *</label>
                <input type="text" class="form-control" id="suburb_name" placeholder="Escriba el nombre de la nueva colonia..." name="suburb_name" required>
        ...
        <div class="col-md-3 mb-1">
            <div class="mb-1">
                <label for="suburb_cp" class="form-label">Código Postal *</label>
                <input type="text" class="form-control" id="suburb_cp" placeholder="52975" name="suburb_cp" required>
...
<div class="modal-footer">
    ...
    <div class="btn btn-dim btn-success" onclick="createSuburb()">
        Crear
    </div>
</div>