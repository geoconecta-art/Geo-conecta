...
class PeterController extends Controller
{
    ...
    public function table(Request $request) {
        ...
        return DataTables::of($people)
            ->addColumn('actions', 'admin.peter._actions')
    ...
    {
        return view('admin.peter.index', [
            'title' => 'Pedro en tu Casa' 
        ]);
    }

    public function create() {
        $view = Person::getCreateViewByType(Person::PEDROENTUCASA);
    ...
    public function store(PersonRequest $request)
    {
        ...
        $person->type = Person::PEDROENTUCASA;
        $person->save();
        $person->setName();
        $person->setAddress();
        ...
        return redirect(route('peter.create'));
    }
    ...
    public function edit($id)
    {
        $person = DB::table('people')
            ->where('id', $id)
            ->where('type', Person::PEDROENTUCASA)
