...
class VolunteerController extends Controller
{
    ...
    public function table(Request $request) {
        ...
        return DataTables::of($people)
            ->addColumn('actions', 'admin.volunteers._actions')
    ...
    public function index()
    {
        return view('admin.volunteers.index', [
            'title' => 'Incorporación Voluntaria' 
        ]);
    }

    public function create() {

        $view = Person::getCreateViewByType(Person::VOLUNTARIO);
    ...
    public function getSectionInfo(Request $request) {
        ...
        return view('admin.volunteers._section-info', [ 
            'section' => $section
        ]);
